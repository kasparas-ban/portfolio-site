...
export default function Page() {
  return (
    <div className="flex flex-col justify-between">
      ...
      <p className="mb-4 dark:text-gray-300 text-sm">Last updated: June 2023</p>
      ...
      <div className="inline-flex w-full mb-4 items-center justify-center">
        ...
        <span className="absolute font-title bg-white px-3 text-2xl font-medium text-gray-900 dark:bg-[#111010] dark:text-gray-300">
          Work experience
        </span>
      </div>
      ...
      <div className="flex items-center">
        <div className="text-lg font-bold dark:text-gray-300 font-title">University of Glasgow</div>
        <div className="ml-auto dark:text-gray-300 font-title">2016 - 2021</div>
      </div>
  ...
  return (
    <div className="mb-8">
      <div className="flex sm:items-center max-sm:flex-col">
        <div className="text-xl font-bold dark:text-gray-200 font-title">{work.title}</div>
        <div className="sm:ml-auto dark:text-gray-300 font-title">{work.period}</div>
      </div>
      <div className="font-medium dark:text-gray-200 font-title">{work.company}</div>
